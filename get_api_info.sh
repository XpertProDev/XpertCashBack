...
echo ""
echo "📝 Pour utiliser le script d'ajout de produits:"
echo "1. Copiez votre token JWT ci-dessus"
echo "2. Modifiez le fichier add_40_products_with_images.sh avec votre token"
